...
public class MoodAnalyserTest {
	...
	/*
	 * In this Repeat UC-2 If user will enetr null data we can handle the exception
	 * We can give input "I am in Happy Mood" to the MoodAnalyserConstructor it will
	 * set it. And in the analyseMoodByConsructor method we return the value if the
	 * input is "I am in Happy Mood" It will Return the Sad
	 */
	@Test
